...
export function ResultsSummaryModal({
  ...
  if (!isVisible || !stream || !difficulty) return null;
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-900 rounded-xl max-w-2xl w-full border-2 border-primary-500 shadow-2xl">
        ...
        <div className="bg-gradient-to-r from-primary-600 to-primary-800 p-8 rounded-t-xl text-center">
          ...
          <p className="text-gray-200 text-lg">
            {stream.icon} {stream.name} - {difficulty.charAt(0).toUpperCase() + difficulty.slice(1)}
          </p>
        </div>
